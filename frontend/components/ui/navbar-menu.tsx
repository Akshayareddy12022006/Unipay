...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative rounded-full border border-transparent dark:bg-white dark:border-black/[0.2] bg-black shadow-input flex justify-center space-x-4 px-8 py-6 "
    >
      {children}
    </nav>
  );
